...
def inner7(local_pass, font):
    ...
    # inner7マスタを読み込む
    Inner7_M = pd.read_csv('../RBS_Master/config/inner7.tsv', sep='\t', encoding=font, dtype='object', index_col=None)
...
def rbs_master():
    ...
    # 管理単位コードの作成
    managed_unit_cd_dict = {'Z': 'Z00', 'P': 'P00', 'I': 'I00'}
