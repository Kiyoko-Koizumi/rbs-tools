...
df2['GTI_Order_Close'] = df2['GTI_Order_Close'].astype(int) # 小数点がつくので整数型へ　出力はstr
df2.to_csv(path + 'temp_data/SPC_Slide.txt', sep='\t', encoding='utf_16', index=False)    # SPC_Slide.txt スライドデータのみ出力
