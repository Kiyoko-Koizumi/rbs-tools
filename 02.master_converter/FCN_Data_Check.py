...
b = pd.DataFrame(pd.read_csv(path + 'FCN_to_ECAL_GRM03622710_Productmst_hou.txt',sep='\t', encoding='utf_16', dtype=str, engine='python', error_bad_lines=False))
...
if len(df) == 0:
    ...
    df3.to_excel(path + 'fcn_ecal_check.xlsx', index=False)
