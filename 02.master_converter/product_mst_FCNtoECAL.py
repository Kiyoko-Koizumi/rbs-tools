...
test = pd.read_csv('C:/Users/Yuichi_Kato/Documents/test/CHN_PRODUCT_MST.txt', sep='\t', encoding='utf_16', dtype=object, engine='python', error_bad_lines=False)
...
#参照先の対象インナー
df = pd.read_excel('C:/Users/Yuichi_Kato/Documents/test/reference.xlsx',dtype={'Inner Code':object})
...
test.to_csv('C:/Users/Chanwook_Heo/Documents/04.マスタ作成/test/output_PRODUCT_MST.txt', sep='\t', encoding='utf_16', index=False)
