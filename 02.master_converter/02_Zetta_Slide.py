...
h_order=({'Subsidiary Code':0,'Stock / MTO':1,'Min Qty of Big Order':2,'Product Code':3,'slide_no':4, 'qty':5, 'sales':6,
           'production':7, 'days_ts':8, 'rt_s':9,'l_rt_s':10,'data':11})  # Header並び順
...
for l in range(0, n):
    ...
    for i in range(1, 11):
        i = str(i)
        zetta_data2 = (zetta_data[['Subsidiary Code', 'Product Code','Stock / MTO','Min Qty of Big Order', 'Slide Qty ' + i, 'Slide Sales Pc/Unit ' + i,
