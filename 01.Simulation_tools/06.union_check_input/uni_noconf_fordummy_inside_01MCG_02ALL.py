...
# 1月はMJP、GRM、CHNは残し、それ以外の現法は従来データのみ残す
data = data[(((data['受注日・見積回答日'].str[0:4] == '2019') & (data['従来生産拠点フラグ'] == '1')) |
            ((data['受注日・見積回答日'].str[0:6] == '202001') & ((data['従来生産拠点フラグ'] == '1') | (data['現法コード'] == 'MJP') | (data['現法コード'] == 'CHN') | (data['現法コード'] == 'GRM'))) |
            ((data['受注日・見積回答日'].str[0:6] == '202002') | (data['受注日・見積回答日'].str[0:6] == '202003') | (data['受注日・見積回答日'].str[0:6] == '202004')) |
             (data['見積有効日'].notnull()))]
